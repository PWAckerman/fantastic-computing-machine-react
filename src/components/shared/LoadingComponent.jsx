...
const LoadingComponent = ()=>{
    return (
        ...
        <svg className="loading-container__svg" width='120px' height='120px' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" preserveAspectRatio="xMidYMid">
            ...
            <g>
                ...
                <path d="M29,23c3.1,11.4,11.3,19.5,21,19.5S67.9,34.4,71,23H29z" clipPath="url(#uil-hourglass-clip1)" fill="#b7f0f7" className="sand"></path>
                <path d="M71.6,78c-3-11.6-11.5-20-21.5-20s-18.5,8.4-21.5,20H71.6z" clipPath="url(#uil-hourglass-clip2)" fill="#faffd1" className="sand"></path>
